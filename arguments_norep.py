...
def buildParser():
	...
	# Data source
	parser.add('--name',          default='weighted_lddt_CPU_no_repeat_data',                     help='Name of folder where result is saved')
	...
	parser.add('--protein_gt_list', default='/home/u2021103648/workspace/dataQA/gt_no_rep.csv',          help='list where all protein native pdb files exist')
	parser.add('--protein_pred_list', default='/home/u2021103648/workspace/dataQA/pred_no_rep.csv',          help='list where all protein predicted pdb files exist')
	...
	parser.add('--n_layers',    default=6,                         help='number of graph-attention layers',    type=int)
	# Other features
